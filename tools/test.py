...
def parse_args():
    ...
    parser.add_argument('--weights',  type=str, default='/home/hanj/yolope/数据/_2024-07-19-17-20_bdd_yolopx_cat2_detectonly/epoch-38.pth', help='model.pth path(s)') # 2023.07.07
